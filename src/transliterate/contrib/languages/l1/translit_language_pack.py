...
__copyright__ = '2016-2018 Marco Pattaro'
...
class Latin1SupplementLanguagePack(TranslitLanguagePack):
    ...
    Though not exactly a language, it's a set of commonly found unicode characters.
    See `http://en.wikipedia.org/wiki/Latin-1_Supplement_%28Unicode_block%29` for details.
    """
    language_code = "l1"
